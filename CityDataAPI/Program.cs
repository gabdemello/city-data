...
builder.Services.AddSwaggerGen(setupAction =>
{
    ...
    setupAction.AddSecurityDefinition("CityDataApiBearerAuth", new OpenApiSecurityScheme()
    {
...
{
    options.AddPolicy("MustBeFromSalvador", policy =>
    {
        policy.RequireAuthenticatedUser();
        policy.RequireClaim("city", "Salvador");
    });
});
